...
# ╔═╡ 82c0f210-e2a6-11ed-3b4a-f9441fb978dd
using LinearAlgebra

# ╔═╡ 82c0f242-e2a6-11ed-274b-352f5e8c3add
using Plots

# ╔═╡ 82c0f13e-e2a6-11ed-0e1f-1f382450e2d8
md"""
# Notebook for 2023-04-28
"""

# ╔═╡ 82c0f29c-e2a6-11ed-2139-417d71a6ec16
md"""
...
# ╔═╡ 82c0f31e-e2a6-11ed-3a86-0f8638ea6930
md"""
...
# ╔═╡ 82c0f3ca-e2a6-11ed-2692-4fc08f40929b
md"""
...
# ╔═╡ 82c0f3fc-e2a6-11ed-3098-f5c5ac241bcd
let
    xhist = []
...
# ╔═╡ 82c0f4e0-e2a6-11ed-00bf-975b332fe57a
md"""
...
# ╔═╡ 82c0f65c-e2a6-11ed-1426-8180ddcc0173
md"""
...
# ╔═╡ 82c0f742-e2a6-11ed-0369-718a51ab12d9
md"""
...
# ╔═╡ 82c0f74c-e2a6-11ed-0dcd-3771490863eb
...
# ╔═╡ 82c0f75e-e2a6-11ed-3b84-11dcfa46c703
let
    x = [2.0; 1.0]
    p = plot_ex16_3()
...
# ╔═╡ 82c0f792-e2a6-11ed-1b7f-4beec990957f
md"""
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "d66cf8be867a87be5be7f683f5a588e7e1428aa1"
