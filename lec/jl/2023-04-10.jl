...
#-cell output=none
savefig("../fig/2023-04-10-biox-cvg.pdf")
#-end
...
#= output=pluto
We start with a not-fantastic initial guess (plotted below).  Getting
a good initial guess is actually an interesting problem, but one that
we will not address here.  From this initial guess, Gauss-Newton does
not have any hope of convergence, but Levenberg-Marquardt does.
=#
...
#-cell output=none
savefig("../fig/2023-04-10-lorx_guess.pdf")
#-end
...
#-cell output=none
savefig("../fig/2023-04-10-lorx_lm.pdf")
#-end

#-cell output=pluto
plot(lorx_resids, yscale=:log10,
     ylabel="\$||J^T f(x_k)||\$", xlabel="\$k\$",
     legend=false)
#-end

#-cell output=none
savefig("../fig/2023-04-10-lorx_lm_cvg.pdf")
#-end
...
#-cell output=none
savefig("../fig/2023-04-10-lorx_vproj.pdf")
#-end
...
#-cell output=none
savefig("../fig/2023-04-10-lorx_vproj_cvg.pdf")
#-end
...
let
    ...
    """
    open("../fig/2023-04-10-rrx.tex", "w") do io print(io, result) end
end
#-end
...
#-cell output=none
savefig("../fig/2023-04-10-rrx-cvg.pdf")
#-end
