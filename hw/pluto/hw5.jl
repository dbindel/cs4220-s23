...
# ╔═╡ c66c6ee9-9424-4b21-89c3-2b8aaa985202
md"""
...
$$\begin{align*}
  \psi_{,i}(x) &= h'(f(x)) f_{,i}(x) \\
  \psi_{,ij}(x) &= h''(f(x)) f_{,i}(x) f_{,j}(x) + h'(f(x)) f_{,ij}(x)
\end{align*}$$
...
$$\begin{align*}
  \nabla \psi(x) &= h'(f(x)) \nabla f(x) \\
  H_{\psi}(x) &= h''(f(x)) \nabla f(x) \nabla f(x)^T + h'(f(x)) H_f
\end{align*}$$
"""

# ╔═╡ abe1ab65-c165-4569-81ef-2abff1d5a9f6
md"""
#### Questions
