...
# ╔═╡ d8b57016-4e5f-4229-a2ea-3b6e14a60681
using QuadGK
...
# ╔═╡ 034deaba-4fda-42f4-99c1-888841ce7157
md"""
#### 1. Function fitting
...
# ╔═╡ 03690414-c16e-4418-8037-698b0a795375
...
# ╔═╡ d6af976f-7410-4276-bbc1-497b9402bb16
...
# ╔═╡ 02b4e4e4-cf51-40e6-9254-ee1b4c2c2c4a
md"""
...
# ╔═╡ 8ffdd51b-7460-45ba-be73-1e44a2a99c94
...
# ╔═╡ 3b9ddf56-3fa3-44b6-b94b-263c41e3c0fa
...
# ╔═╡ f6184c58-d7db-4858-b560-849ffeea9248
md"""
...
Note that if $p(x) = \sum_{j=0}^d w_j T_j(x)$, then for our example we expect $p(x)-1 = w^T B^\dagger \eta$ to be a normal random variable with mean zero and standard deviation $\|w^T B^\dagger\|$.  We can write this in Julia as `w' / B`.
"""
...
# ╔═╡ d11b5afc-3629-47f4-a1e1-1debc660a073
md"""
##### Questions
...
# ╔═╡ 4f95ca14-8a66-490e-8bbb-8426eeaaa5b2
md"""
...
$$\begin{align*}
Q(x) &= \begin{bmatrix} q_0(x) & \ldots & q_d(x) \end{bmatrix} \\
P(x) &= \begin{bmatrix} x^0 & \ldots & x^d \end{bmatrix}
\end{align*}$$
"""

# ╔═╡ a35f017f-fb4e-499f-9f40-f6f8bbb146f5
md"""
#### 3. Chopping Cholesky
...
# ╔═╡ 5d63985d-58bc-4062-89fd-67afa939bf6e
...
# ╔═╡ f8a6230b-f5c6-4415-b079-447f103c9d37
...
# ╔═╡ f8646924-9891-4943-ab51-ffc7e51c641a
...
# ╔═╡ a820e5cd-bdaf-4b0f-a5ac-1b142467c945
let
	A = rand(10,10)
	A = A'*A
	R = cholesky(A).U
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "f4244987d6ede27fe98e7a9fa98068531dbed720"
